    ...
    <div class="modal-content">
      ...
      <div class="tile">
            ...
            <div class="tile-body">
              ...
              <button class="btn btn-outline-info type="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i>Save</button>&nbsp;&nbsp;&nbsp;<a class="btn btn-outline-dark" href="#"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancel</a>
            </div>
              </form>
            </div>
